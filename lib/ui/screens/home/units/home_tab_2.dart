...
class HomeTab2 extends GetResponsiveView {
  HomeTab2({super.key});
  ...
  Widget desktop() {
    return Row(
      ...
      children: [
        ...
        Dimens.width(27).pw,
        SvgPicture.asset(SvgAssets.tab2Image2, width: Dimens.width(502)),
      ],
    );
  }
